...
Rol de la IA:
La IA actúa como un analista de Customer Health que interpreta métricas operativas y de experiencia del cliente para identificar señales tempranas de riesgo y apoyar la toma de decisiones preventivas.

¿Cómo funcionaría el asistente?

El usuario ingresa métricas clave del cliente, como puntualidad, NPS, quejas, incidentes y rechazos.
El asistente analiza estos datos, determina el nivel de riesgo del cliente y genera un diagnóstico breve junto con un plan de acción sugerido, priorizando la prevención y la mejora de la relación con el cliente.
